...
export const SignInPageComponent = () => {
  return (
    <>
      <div className="bg-base-canvas-default border-base-divider-subtle border-b">
        <div className="container mx-auto flex items-center px-4 py-3">
          <NextLink
            href="/"
            className="text-base-content-default hover:text-base-content-strong inline-flex items-center gap-1 text-sm"
          >
            <BiArrowBack className="size-4" aria-hidden />
            Home
          </NextLink>
        </div>
      </div>
      <div className="lg:from-interaction-main-subtle-default lg:to-base-canvas-default flex flex-1 lg:bg-linear-to-r lg:from-50% lg:to-50%">
