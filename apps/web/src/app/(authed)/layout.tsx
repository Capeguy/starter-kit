      ...
      <HydrateClient>
        <CommandPaletteProvider>
          <main className="flex min-h-dvh flex-col">
             ...
             * that crashes below it still leave the navbar + command palette
             * interactive — users can still navigate, log out, or open the
             * account menu while seeing the friendly fallback. This is the
             * React render-error boundary; Next.js's segment-level crashes are
             * caught by `error.tsx`.
             */}
