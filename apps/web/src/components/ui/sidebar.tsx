  ...
  (
    ...
    if (collapsible === 'none') {
      return (
        <div
          className={cn(
            'bg-sidebar text-sidebar-foreground flex h-full w-(length:--sidebar-width) flex-col',
            className,
          )}
          ref={ref}
          {...props}
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="bg-sidebar text-sidebar-foreground w-(length:--sidebar-width) p-0 [&>button]:hidden"
            style={
              {
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            'relative w-(length:--sidebar-width) bg-transparent transition-[width] duration-200 ease-linear',
            'group-data-[collapsible=offcanvas]:w-0',
            'group-data-[side=right]:rotate-180',
            variant === 'floating' || variant === 'inset'
              ? 'group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)_+_var(--spacing-4))]'
              : 'group-data-[collapsible=icon]:w-(length:--sidebar-width-icon)',
          )}
        />
        <div
          className={cn(
            'fixed inset-y-0 z-10 hidden h-svh w-(length:--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex',
            side === 'left'
            ...
            variant === 'floating' || variant === 'inset'
              ...
              : 'group-data-[collapsible=icon]:w-(length:--sidebar-width-icon) group-data-[side=left]:border-r group-data-[side=right]:border-l',
            className,
          )}
          {...props}
        >
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      <Skeleton
        className="h-4 max-w-(length:--skeleton-width) flex-1"
